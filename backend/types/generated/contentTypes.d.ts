...
export interface ApiCommercialActivityCommercialActivity
  extends Struct.CollectionTypeSchema {
  collectionName: 'commercial_activities';
  info: {
    description: 'Horse commercial activities and races';
    displayName: 'Commercial Activity';
    pluralName: 'commercial-activities';
  ...
  attributes: {
    ...
    activityType: Schema.Attribute.Enumeration<
      ['race', 'exhibition', 'sale', 'breeding', 'sponsorship']
    > &
      Schema.Attribute.Required;
    amount: Schema.Attribute.Decimal;
    buyer: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    createdAt: Schema.Attribute.DateTime;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::commercial-activity.commercial-activity'
    > &
      Schema.Attribute.Private;
    prizeMoney: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiFeedingRecordFeedingRecord
  extends Struct.CollectionTypeSchema {
  collectionName: 'feeding_records';
  info: {
    description: 'Horse feeding records';
    displayName: 'Feeding Record';
    pluralName: 'feeding-records';
    singularName: 'feeding-record';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    feedDate: Schema.Attribute.DateTime & Schema.Attribute.Required;
    feedType: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    ...
    unit: Schema.Attribute.Enumeration<['kg', 'lb', 'g']> &
...
export interface ApiHealthRecordHealthRecord
  extends Struct.CollectionTypeSchema {
  collectionName: 'horse_health_records';
  info: {
    description: 'Horse health measurements and data';
    displayName: 'Health Record';
    pluralName: 'health-records';
    singularName: 'health-record';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    bloodPressure: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 20;
      }>;
    createdAt: Schema.Attribute.DateTime;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::health-record.health-record'
    > &
      Schema.Attribute.Private;
    notes: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiHorseHorse extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Horse information and profiles';
    displayName: 'Horse';
    pluralName: 'horses';
    singularName: 'horse';
  };
  ...
  attributes: {
    ...
    commercialActivities: Schema.Attribute.Relation<
      'oneToMany',
      'api::commercial-activity.commercial-activity'
    >;
    ...
    healthData: Schema.Attribute.Relation<
      'oneToMany',
      'api::health-record.health-record'
    >;
    ...
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::horse.horse'> &
      Schema.Attribute.Private;
    medicalRecords: Schema.Attribute.Relation<
      'oneToMany',
    ...
    stableLocation: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
...
export interface ApiInsuranceInsurance extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Horse insurance information';
  ...
  attributes: {
    ...
    coverageAmount: Schema.Attribute.Decimal;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    endDate: Schema.Attribute.Date & Schema.Attribute.Required;
    horse: Schema.Attribute.Relation<'oneToOne', 'api::horse.horse'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::insurance.insurance'
    ...
    publishedAt: Schema.Attribute.DateTime;
    renewalReminder: Schema.Attribute.Boolean &
...
export interface ApiMedicalRecordMedicalRecord
  ...
  info: {
    description: 'Horse medical records';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    nextAppointment: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    recordDate: Schema.Attribute.Date & Schema.Attribute.Required;
    recordType: Schema.Attribute.Enumeration<
      ['vaccination', 'checkup', 'illness', 'deworming', 'dental', 'surgery']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiNotificationSettingNotificationSetting
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    emailCommercialActivity: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    emailHorseStatusChange: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    emailInsuranceReminder: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    emailVaccinationReminder: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    reminderDaysBefore: Schema.Attribute.JSON &
      Schema.Attribute.DefaultTo<[30, 7, 1]>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
